...
function animarMenu() {
  $(document).scroll(function () {
    ...
    if (height > 100) {
      ...
      $('.navbar').css("padding", ".8em 2em .8em 2em")
    } else {
      $('.navbar').css("background", "transparent")
      $('.navbar').css("padding", "2em 2em 2em 2em")
    }
...
function collapsible() {
  var coll = document.getElementsByClassName("collapse-sub-menu");
  var i;

  for (i = 0; i < coll.length; i++) {
    coll[i].addEventListener("click", function () {
      var content = this.nextElementSibling;
      this.classList.toggle("collapse-sub-menu-active")
      content.classList.toggle("sub-menu-drop")
    });
  }
}
...
smartlook('init', 'f0226468b5c8bd6d710d4c3246ca05565b70eebf');
